...
import { useBranch, type Branch } from "../../composables/useBranch";

const { search, filteredBranches, addBranch, updateBranch, deleteBranch } =
  useBranch();
...
const saveBranch = () => {
  ...
  if (editingId.value) {
    updateBranch(editingId.value, branchData);
  ...
  <div class="space-y-6">
    ...
    >
      ...
      >
        ...
        <form @submit.prevent="saveBranch" class="space-y-5 p-6">
          <div>
