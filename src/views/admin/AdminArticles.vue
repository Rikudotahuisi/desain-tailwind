  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-slate-500">
          Kelola artikel kesehatan di ASSYIFA Hospital
        </p>
      </div>
      <button
        @click="goToCreate"
    ...
    >
            ...
            >
              <td class="py-3 px-4">
                <div class="flex items-center gap-3">
                  <div
                    class="w-12 h-12 rounded-lg overflow-hidden flex-shrink-0 bg-slate-200"
                  >
                    <img
                      :src="article.image"
                      :alt="article.title"
              ...
              <td class="py-3 px-4">
                <span
                  class="px-2.5 py-1 rounded-full text-xs font-medium bg-teal-50 text-teal-600"
                >
                  {{ article.category }}
                </span>
              </td>
              ...
              <td class="py-3 px-4 text-center">
                ...
                <button
                  @click="deleteArticleRow(article.id)"
      ...
      <div v-if="filteredArticles.length === 0" class="py-12 text-center">
        ...
        <p class="text-sm text-slate-500">
          Klik tombol "Tambah Artikel" untuk menambahkan artikel baru
        </p>
      </div>
    </div>
  </div>
