  ...
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-slate-500">
          Kelola nomor antrian di ASSYIFA Hospital
        </p>
      </div>
      <button
    ...
    >
            ...
            >
              <td class="py-3 px-4">
                <span class="font-bold text-teal-600">{{
                  booking.nomorAntrian
                }}</span>
              </td>
              <td class="py-3 px-4">
                <p class="font-medium text-slate-900">
                  {{ booking.pasien.namaPasien }}
                </p>
              ...
              <td class="py-3 px-4 text-center">
                <button
                  @click="router.push(`/admin/antrian/edit/${booking.id}`)"
      ...
      <div v-if="filteredBookings.length === 0" class="py-12 text-center">
        ...
        <p class="text-sm text-slate-500">
          Belum ada nomor antrian yang cocok dengan filter ini
        </p>
      </div>
    </div>
  </div>
...
const filteredBookings = computed(() => {
  let filtered = [...bookings.value].sort((a, b) =>
