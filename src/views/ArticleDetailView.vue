<template>
  <div class="min-h-screen bg-slate-50 pt-[140px] pb-16">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <!-- ========================================== -->
      <!-- HEADER SECTION: BREADCRUMB + TOMBOL KEMBALI -->
      <!-- ========================================== -->
      ...
      <!-- NOT FOUND STATE -->
      <!-- ========================================== -->
      <div v-if="!article" class="rounded-3xl bg-white p-12 text-center shadow-lg">
      ...
      <!-- DETAIL ARTIKEL -->
      <!-- ========================================== -->
      <article v-else class="overflow-hidden rounded-3xl bg-white shadow-lg">
