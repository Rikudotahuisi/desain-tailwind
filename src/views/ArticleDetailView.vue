<template>
  <div class="min-h-screen bg-slate-50" style="padding-top: 170px">
    <div class="mx-auto max-w-[1000px] px-6 lg:px-16 -mt-6">
      ...
      <div
        v-if="!article"
        class="bg-white rounded-3xl shadow-lg p-12 text-center mb-10"
      >
      ...
      <article
        v-else
        class="bg-white rounded-3xl shadow-lg overflow-hidden mb-10"
      >
        <!-- Featured Image -->
        ...
        <div class="p-6 md:p-8">
          <!-- Author -->
          <div
            class="flex items-center gap-3 mb-6 pb-6 border-b border-slate-100"
          >
            <div
              class="w-12 h-12 rounded-full bg-teal-100 flex items-center justify-center text-teal-600 font-bold text-lg"
            >
          ...
          <div class="mt-8 pt-6 border-t border-slate-100">
            <div class="flex flex-wrap items-center justify-between gap-4">
              <div class="flex items-center gap-3">
                ...
                <button
                  class="w-9 h-9 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition flex items-center justify-center"
                >
                  <i class="fab fa-facebook-f text-sm"></i>
                </button>
                <button
                  class="w-9 h-9 rounded-full bg-sky-500 text-white hover:bg-sky-600 transition flex items-center justify-center"
                >
                  <i class="fab fa-twitter text-sm"></i>
                </button>
                <button
                  class="w-9 h-9 rounded-full bg-green-600 text-white hover:bg-green-700 transition flex items-center justify-center"
                >
                  <i class="fab fa-whatsapp text-sm"></i>
                </button>
                <button
                  class="w-9 h-9 rounded-full bg-slate-600 text-white hover:bg-slate-700 transition flex items-center justify-center"
                >
              ...
              <div class="flex items-center gap-3">
                <button
                  class="flex items-center gap-2 text-sm text-slate-500 hover:text-red-500 transition"
                >
                  <i class="far fa-heart"></i>
                  <span>Suka</span>
                </button>
                <button
                  class="flex items-center gap-2 text-sm text-slate-500 hover:text-teal-500 transition"
                >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <h4
                      class="text-sm font-semibold text-slate-900 group-hover:text-teal-600 transition line-clamp-2"
                    >
                      {{ related.title }}
                    </h4>
