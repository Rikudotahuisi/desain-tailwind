<template>
  <div class="min-h-screen bg-slate-50 pt-[140px] pb-16">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <div
        v-if="!article"
        class="mb-10 rounded-3xl bg-white p-12 text-center shadow-lg"
      >
      ...
      <article
        v-else
        class="mb-10 overflow-hidden rounded-3xl bg-white shadow-lg"
      >
        <!-- Featured Image -->
        <div class="relative h-72 overflow-hidden md:h-96">
          ...
          >
            <div class="flex flex-wrap items-center gap-3">
              <span
                class="rounded-full bg-teal-500 px-3 py-1 text-xs font-semibold text-white"
              >
                {{ article.category }}
              </span>
        ...
        <div class="p-6 md:p-8">
          <!-- Author -->
          <div
            class="mb-6 flex items-center gap-3 border-b border-slate-100 pb-6"
          >
            <div
              class="flex h-12 w-12 items-center justify-center rounded-full bg-teal-100 text-lg font-bold text-teal-600"
            >
          ...
          <div class="mt-8 rounded-2xl border border-teal-100 bg-teal-50 p-6">
            ...
            <ul class="mt-3 space-y-2 text-slate-700">
              <li class="flex items-start gap-3">
                ...
                <span
                  >Konsultasikan selalu dengan dokter sebelum menerapkan tips
                  kesehatan</span
                >
              </li>
              <li class="flex items-start gap-3">
          ...
          <div class="mt-8 border-t border-slate-100 pt-6">
            <div class="flex flex-wrap items-center justify-between gap-4">
              <div class="flex items-center gap-3">
                ...
                <button
                  class="flex h-9 w-9 items-center justify-center rounded-full bg-blue-500 text-white transition hover:bg-blue-600"
                >
                  <i class="fab fa-facebook-f text-sm"></i>
                </button>
                <button
                  class="flex h-9 w-9 items-center justify-center rounded-full bg-sky-500 text-white transition hover:bg-sky-600"
                >
                  <i class="fab fa-twitter text-sm"></i>
                </button>
                <button
                  class="flex h-9 w-9 items-center justify-center rounded-full bg-green-600 text-white transition hover:bg-green-700"
                >
                  <i class="fab fa-whatsapp text-sm"></i>
                </button>
                <button
                  class="flex h-9 w-9 items-center justify-center rounded-full bg-slate-600 text-white transition hover:bg-slate-700"
                >
              ...
              <div class="flex items-center gap-3">
                <button
                  class="flex items-center gap-2 text-sm text-slate-500 transition hover:text-red-500"
                >
                  <i class="far fa-heart"></i>
                  <span>Suka</span>
                </button>
                <button
                  class="flex items-center gap-2 text-sm text-slate-500 transition hover:text-teal-500"
                >
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              >
                <div class="flex items-center gap-4">
                  <div
                    class="h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg"
                  >
                    <img
                      :src="related.image"
                      :alt="related.title"
                  ...
                  <div>
                    <h4
                      class="line-clamp-2 text-sm font-semibold text-slate-900 transition group-hover:text-teal-600"
                    >
                      {{ related.title }}
                    </h4>
