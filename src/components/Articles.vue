      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        >
          <div class="relative h-48 overflow-hidden bg-teal-100">
            ...
            />
            <span
              class="absolute top-4 left-4 rounded-full bg-teal-500 px-3 py-1 text-xs font-semibold text-white"
            >
          ...
          <div class="p-6">
            ...
            <h3
              class="mt-1 text-lg font-bold text-slate-900 group-hover:text-teal-600 transition-colors line-clamp-2"
            >
              {{ article.title }}
            </h3>
            ...
            <span
              class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-teal-600 transition group-hover:text-teal-700"
            >
              Baca Selengkapnya
