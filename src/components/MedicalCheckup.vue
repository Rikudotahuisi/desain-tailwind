  ...
  <section id="medical-checkup" class="scroll-mt-20 py-20 bg-slate-50">
    <div class="mx-auto max-w-[1400px] px-6 lg:px-16">
      ...
      >
        ...
        >
          <div
            class="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full text-2xl transition-colors"
            :class="[
              selectedSkrining === index
      ...
      <div
        v-if="selectedSkrining !== null"
        class="mt-12 rounded-3xl bg-white p-8 shadow-xl"
      >
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2">
            <div class="flex items-start gap-4">
              <div
                class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-teal-50 text-3xl text-teal-600"
              >
            ...
            <div class="mt-6 rounded-xl bg-blue-50 p-4">
              ...
              <p class="text-sm text-slate-600">
                {{ skriningItems[selectedSkrining].recommended }}
              </p>
            </div>
          </div>
          ...
          <div class="lg:col-span-1">
            ...
            >
              ...
              <p class="text-4xl font-bold text-teal-600">
                {{ skriningItems[selectedSkrining].price }}
              </p>
