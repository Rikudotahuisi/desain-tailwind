      ...
      <div class="mb-12 flex flex-wrap items-end justify-between">
        <div>
          ...
          <p class="mt-2 text-lg text-slate-600">
            Konsultasikan kesehatan Anda dengan dokter spesialis berpengalaman
            di bidangnya.
          </p>
        </div>
        <router-link
      ...
      >
        ...
        >
          ...
          <div class="relative mx-auto h-32 w-32 overflow-hidden rounded-full">
            ...
            />
            <div
              class="absolute inset-0 rounded-full bg-teal-500/0 transition-colors group-hover:bg-teal-500/10"
            ></div>
            <div
              v-if="isPracticingNow(doctor)"
              class="absolute bottom-1 right-1 h-4 w-4 rounded-full bg-green-500 ring-2 ring-white animate-pulse"
            ></div>
          </div>
          ...
          <p class="text-center text-sm font-medium text-teal-600">
            {{ doctor.specialty }}
          </p>
          ...
          <div class="mt-4 rounded-xl bg-slate-50 p-4">
            <div class="flex items-center justify-between text-sm">
              <span class="font-medium text-slate-700">
                <i class="far fa-calendar-alt mr-2 text-teal-500"></i>Jadwal
                Praktek
              </span>
              <span
                v-if="isPracticingNow(doctor)"
            ...
            <div class="mt-2 space-y-1 text-sm text-slate-600">
              <div
                v-for="schedule in activeSchedule(doctor)"
                :key="schedule.day"
