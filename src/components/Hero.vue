          ...
          <div class="relative z-10 flex h-full items-center">
            <div class="mx-auto w-full max-w-[1400px] px-6 lg:px-16">
              <div class="max-w-[700px]">
                <h1
                  class="text-6xl font-bold leading-[1.05] tracking-[-0.03em] text-white sm:text-7xl lg:text-[80px]"
                >
                  {{ slide.title }}
                </h1>
                <p
                  v-if="slide.description"
                  class="mt-6 max-w-[540px] text-lg leading-relaxed text-white/70"
                >
                  {{ slide.description }}
                </p>
                <div
                ...
                >
                  ...
                  >
                    ...
                    <span
                      v-if="i === 0"
                      class="absolute inset-0 scale-0 bg-teal-400 transition-transform duration-300 group-hover:scale-100"
                    ></span>
                  </a>
                </div>
              </div>
